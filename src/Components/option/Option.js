...
const Option = ({ i, index, setIndex, userId }) => {
  ...
  const sendNotification = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:5001/api/send-message?title=Order Ready&body=Your order is now ready for pickup&url=https://shivaaysweets.vercel.app`, {
